...
type AiUsage = {
  ...
  features: { name: string; parentId: string | null; parentName: string; requests: number; inputTokens: number; outputTokens: number; estimatedCostUsd: number }[];

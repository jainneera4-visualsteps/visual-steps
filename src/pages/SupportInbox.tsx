...
import { CalendarDays, CheckCircle2, ChevronLeft, ChevronRight, Inbox, Mail, MailOpen, RefreshCw, Reply, ShieldCheck } from 'lucide-react';
...
export default function SupportInbox() {
  ...
  const filters: Array<{ id: 'all' | SupportStatus; label: string }> = [{ id: 'unread', label: 'Unread' }, { id: 'open', label: 'Read & Working' }, { id: 'resolved', label: 'Resolved' }, { id: 'all', label: 'All messages' }];

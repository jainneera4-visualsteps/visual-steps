...
import { CommunityRichTextEditor, FormattedNewsletterContent, IssueCard } from './Newsletter';
...
type NewsletterAdminSection = 'settings' | 'subscribers' | 'submissions' | 'template';
const newsletterAdminSections: { key: NewsletterAdminSection; label: string }[] = [
  { key: 'settings', label: 'Newsletter Settings' },
  { key: 'subscribers', label: 'Subscriber Delivery Status' },
  { key: 'submissions', label: 'Community Submissions' },
...
export default function NewsletterAdmin() {
  ...
  const activeSection: NewsletterAdminSection = newsletterAdminSections.some(section => section.key === requestedSection)
    ? requestedSection as NewsletterAdminSection
    : 'settings';

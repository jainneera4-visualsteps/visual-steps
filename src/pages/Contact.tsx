...
export default function Contact() {
  ...
  return <div className="page-shell"><div className="page-container space-y-8">
    ...
    <section className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[0.7fr_1.3fr]">
      <aside className="space-y-4"><div className="app-callout"><MessageSquareText className="h-6 w-6 text-brand-700" /><h2 className="mt-3 font-bold">What to include</h2><p className="mt-2 text-sm leading-6 text-slate-600">Tell us which page you were using, what you expected, and what happened. Never send a password, API key, child login code, or sensitive clinical information.</p></div><div className="app-callout"><ShieldCheck className="h-6 w-6 text-emerald-700" /><h2 className="mt-3 font-bold">Your privacy</h2><p className="mt-2 text-sm leading-6 text-slate-600">This form opens your own email application. Visual Steps does not store the form fields in its database.</p></div></aside>

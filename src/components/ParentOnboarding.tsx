...
const guidedSteps = [
  ...
  },
  {
    ...
    description: 'Offer meaningful activities as choices, then make each chosen activity predictable with clear visual steps.',
    bullets: ['The learner may choose available activities in any order and need not choose them all.', 'Break one activity into small, understandable visual steps.', 'Use timing and parent verification only when they help this learner.'],
    tip: 'Activity → Steps provides structure inside a choice, not a checklist for the whole day.',
  },
  {
    icon: Check,
    eyebrow: 'Support progress',
    title: 'Respond to the activity they chose',
    description: 'Review work submitted for verification when needed, without treating other available choices as unfinished tasks.',
    bullets: ['See which activity is waiting for your review.', 'Verify completion before its tokens are awarded.', 'Reassign only when another attempt would be helpful.'],
    tip: 'An activity not chosen today is a parent planning record, not a learner failure.',
  },
  {
    icon: PauseCircle,
  ...
  },
  {
    ...
    title: 'Notice effort without making it a transaction',
    description: 'Give a specific positive recognition message without tokens. Bonus tokens are a separate parent choice.',
    bullets: ['Name something you genuinely noticed, such as asking for help or trying again.', 'The learner sees recognition under You Were Noticed.', 'Use Give Bonus Tokens separately when tokens are appropriate.'],
    tip: 'Recognition can be meaningful on its own, without adding to the reward balance.',
  },
  {
    icon: BarChart3,

...
const steps = [
  ...
  { route: `/assigned-activities/${GUEST_KID_ID}`, target: 'main', title: 'Review work before granting rewards', body: 'Open To Be Verified to see work waiting for a parent. Verify & Complete grants the earned reward. Reassign returns the same activity for another supported attempt.' },

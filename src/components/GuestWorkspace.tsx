...
const guidedSteps: GuidedStep[] = [
  ...
  { route: activityRoute, target: '[data-guest-tour="activity-reward-amount"]', title: 'Match the reward to the activity', body: 'Choose the number earned for this specific activity according to the learner’s effort and challenge. Each activity can use a different amount, and rewards are added only after completion or required verification.', prepare: ['[data-guest-tour="add-activity"]'] },
  ...
  { route: childRoute, target: '[data-guest-tour="child-activities"]', title: 'See available activities', body: 'This tab shows the learner’s currently available choices. The optional Activities Shown at Once setting can reduce visual overload without changing which activities are important, mandatory, or first.', prepare: ['[data-guest-tour="child-activity-close"]'], activate: '[data-guest-tour="child-activities"]' },

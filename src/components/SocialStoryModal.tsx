...
import { X, ChevronLeft, ChevronRight, Volume2, Square, Printer, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 md:p-8">
      <div className="relative w-full max-w-5xl h-full max-h-[90vh] flex flex-col bg-white rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-200">
        ...
        {/* Book Content */}
        <div className="flex-1 relative overflow-hidden flex items-center justify-center bg-slate-100/50 p-4 md:p-8">
